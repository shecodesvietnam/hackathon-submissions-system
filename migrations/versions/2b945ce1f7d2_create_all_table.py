...
Revision ID: 2b945ce1f7d2
Revises: 
Create Date: 2021-07-12 21:50:01.762588
...
def upgrade():
    ...
    sa.Column('proj_name', sa.String(length=100), nullable=True),
    ...
    sa.Column('is_judge', sa.Boolean(), nullable=True),

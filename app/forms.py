...
class GradeForm(FlaskForm):
    creative = IntegerField(validators=[DataRequired(), Length(min=0, max=15)], widget=NumberInput(min=0, max=15))
    accessible = IntegerField(validators=[DataRequired(), Length(min=0, max=30)], widget=NumberInput(min=0, max=30))
    demo = IntegerField(validators=[DataRequired(), Length(min=0, max=15)], widget=NumberInput(min=0, max=15))
